...
do
    ...
    #python scripts/MakeSigPlot.py -p ${OUT} -w ${DIR}/Node_SM/ws_hhbbgg.HH.sigVBF.mH125_13TeV.root -c ${icat} -o "mjj,mgg" -l "2016+2017+2018 analysis" -a "#font[61]{pp#rightarrowHH#rightarrowb#bar{b}#gamma#gamma}|SM-like HH" -b 24,160 -d 1
