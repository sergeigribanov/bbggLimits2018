...
Bool_t bbggLTMaker::Process(Long64_t entry)
{
  ...
  */ 
  //if ( _normalization!=1 && _genDiPhotonFilter==0) o_weight=o_weight*btagnorm*reweight/(F_year/1.06); //LO ggHH signal 
  if ( _normalization!=1 && _genDiPhotonFilter==0) o_weight=o_weight*btagnorm*reweight; //NLO ggHH signal
  ...
  {
    o_weight=o_weight*btagnorm*reweightvbfhh; //VBFHH signal
...
//=========with cut =========================
  //Categorisation for boundaries from flashgg. VBFHH categories
    ...
    */
    //===============     
    /*
    //16 cats - for SM_c2v01_noCosTheta    for full RUN2
    ...
    */   
    //===============
    /*
    //16 cats - for SM_c2v01_noCosTheta    for full RUN2 - optimisation from Tatyana
    if( absCosThetaStar_CS < 0.943 && MVAOutput_vbf_gg > 0.9881 && MVAOutput_vbf_ggf>0.96 && ttHScore > 0.26 && leadingJet_pt/Mjj > 0.55 ) {
       o_catID = 12;
    }
    else if( absCosThetaStar_CS < 0.943 && MVAOutput_vbf_gg > 0.9606 && MVAOutput_vbf_gg < 0.9881 && MVAOutput_vbf_ggf>0.96 && ttHScore > 0.26 && leadingJet_pt/Mjj > 0.55 ) {
       o_catID = 13;
    }
    else if( absCosThetaStar_CS > 0.943 && MVAOutput_vbf_gg > 0.9881 && MVAOutput_vbf_ggf>0.96 && ttHScore > 0.26 && leadingJet_pt/Mjj > 0.55 ) {
       o_catID = 14;
    }
    else if( absCosThetaStar_CS > 0.943 && MVAOutput_vbf_gg > 0.9606 && MVAOutput_vbf_gg < 0.9881 && MVAOutput_vbf_ggf>0.96 && ttHScore > 0.26 && leadingJet_pt/Mjj > 0.55 ) {
       o_catID = 15;
    ...
    */
    /*
    //tight MVAOutputTransformed_vbf_ggf cut
    ...
    */
    /*
    //loose MVAOutputTransformed_vbf_ggf cut
    if( absCosThetaStar_CS < 0.88 &&  MVAOutputTransformed_vbf_gg >= 0.59 && MVAOutputTransformed_vbf_ggf>0.1 && ttHScore > 0.26 && leadingJet_pt/Mjj > 0.55 ) {
       o_catID = 12;
    }
    else if( absCosThetaStar_CS < 0.88 && MVAOutputTransformed_vbf_gg > 0.541 && MVAOutputTransformed_vbf_gg < 0.59 && MVAOutputTransformed_vbf_ggf>0.1 && ttHScore > 0.26 && leadingJet_pt/Mjj > 0.55 ) {
       o_catID = 13;
    }
    else if( absCosThetaStar_CS >= 0.88 &&  MVAOutputTransformed_vbf_gg >= 0.59 && MVAOutputTransformed_vbf_ggf>0.1 && ttHScore > 0.26 && leadingJet_pt/Mjj > 0.55 ) {
       o_catID = 14;
    }
    else if( absCosThetaStar_CS >= 0.88 && MVAOutputTransformed_vbf_gg > 0.541 && MVAOutputTransformed_vbf_gg < 0.59 && MVAOutputTransformed_vbf_ggf>0.1 && ttHScore > 0.26 && leadingJet_pt/Mjj > 0.55 ) {
       o_catID = 15;
    ...
    */    
    /*
    //from Tatyana loose cut on MVAOutputTransformed_vbf_ggf 
